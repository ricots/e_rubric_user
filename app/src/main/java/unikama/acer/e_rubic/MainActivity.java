...
import unikama.acer.e_rubic.fragment.HomeFragment;
import unikama.acer.e_rubic.fragment.history;
import unikama.acer.e_rubic.fragment.pengisian_nilai;
    ...
    private void navigate(final int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_1:
                ...
                navFragment = new pengisian_nilai();
                break;
            case R.id.nav_2:
                mPrevSelectedId = itemId;
                setTitle(R.string.nav_reward);
                navFragment = new history();
                break;
            //case R.id.nav_5:
